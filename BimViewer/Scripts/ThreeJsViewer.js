function ThreeJsViewer(){
    ...
    this.loadSerializedModel = function(serializedModel){
        ...
        //var myJSON;
        //var model1;
        //$.getJSON(serializedModel, function (data) {
        //    myJSON = data;
        //});
        //model1 = JSON.parse(myJSON);
        //var loader = new THREE.ObjectLoader();
        //var loadedScene1 = loader.parse(model1, function (object) { });
        ...
        //this.root.add.apply(this.root, loadedScene1.children);
        //this.centerScene();
